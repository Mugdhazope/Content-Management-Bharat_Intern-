...
$sql = "SELECT * FROM leads WHERE (contact_num LIKE '%$searchTerm%' OR name LIKE '%$searchTerm%' OR ref_name LIKE '%$searchTerm%' OR ref_contact LIKE '%$searchTerm%') AND assigned = '$loggedInUser' AND status = 'paid'";
