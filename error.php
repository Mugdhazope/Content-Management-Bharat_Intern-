...
<div class="box">
  ...
  <div class="box__description">
    <div class="box__description-container">
      ...
      <div class="box__description-text">Its seems we have an error , contact : 7700007543</div>
      <div class="box__description-text">OR</div>
    </div>
    
    <a onclick="goBack()"class="box__button">Go back</a>
